...
libname CKW2 "C:\\Users\\¤ı«FÒj\\Desktop\\RA\\Kim_Cha\\results";
%let coordinate_file = C:\\Users\\¤ı«FÒj\\Desktop\\RA\\Kim_Cha\\Data\\data\\zipcode_Census_2000.xlsx;
%let out_file = C:\\Users\\¤ı«FÒj\\Desktop\\RA\\Kim_Cha\\results\\mna_media_distance.csv;
%let out = C:\Users\¤ı«FÒj\Desktop\RA\Kim_Cha\results\; 

data mna_media; 
	set CKW2.mna_media_conservatism2; 
run;

data zip_data;
	set CKW.comp_cik_03_18_media;
run;

proc import datafile="&coordinate_file" 
	dbms=xlsx 
	out=coordinate_data
	replace;
run;
...
libname outlib "&out";
data outlib.mna_media_distance; set mna_media_tcoor; run; 
proc export data=outlib.mna_media_distance outfile="&out_file" dbms=csv replace; putnames=yes; run;
