*****************************************************************************;
* Last Update: 2025/9													    *;
* This SAS code calculate combined CAR, which is one of dependent           *; 
* variable in our work                                                      *;																	
*****************************************************************************;
...
****************************************************************************
Part2 - get acquirer outstanding shares & price 4 days before announcement
****************************************************************************;
...
proc sort data=amve_before_ann;
...
****************************************************************************
Part3 - get target outstanding shares & price 4 days before announcement
****************************************************************************;
...
*select the 4th trading day before announcement date, following IX 2014, JFE;   
proc sort data=tmve_before_ann;
	by dealid descending date;
run;
