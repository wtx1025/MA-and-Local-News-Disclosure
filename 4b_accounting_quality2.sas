...
***********************************************************************
Part1 - Import compustat data & mna_media_aq & audit analytics data
***********************************************************************;

libname CKW "C:\\Users\\¤ý«FÒj\\Desktop\\RA\\Kim_Cha\\results"; 
data mna_media_aq;
	set CKW.mna_media_aq;
run;
...
proc import datafile="C:\\Users\\¤ý«FÒj\\Desktop\\RA\\Kim_Cha\\Data\\data\\aa_data.csv" 
	dbms=csv 
	out=aa_data
	replace;
run; 
...
*************************************************************
Part2 - find acquirer cik and target cik for mna_media_aq
*************************************************************;
...
*************************************************************
Part3 - Prepare the big4 for each cik*year in aa_data
*************************************************************;
...
*****************************************************
Part4 - create list of auditors for each cik*year
*****************************************************;
...
*****************************************************************
Part5 - merge big4 for acquirer and target back to mna_media_aq
*****************************************************************;
...
****************************************
Part6 - Construct SharedAuditor
****************************************;

data mna_with_tbig4;
	set mna_with_tbig4;
	length SharedAuditor 8;            /* ¼Æ­È«¬ */
