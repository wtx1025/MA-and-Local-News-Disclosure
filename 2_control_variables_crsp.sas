...
data mna_media; set CKW.mna_media_comp; run;
...
*******************************************
Part2 - Compute runup for target firms
*******************************************;
...
proc sort data=ta_event_ret out=ta_event_ret_sorted; by dealid date; run;
...
*******************************************
Part3 - Compute runup for acquirer firms
*******************************************;
...
proc sort data=before_ann; by dealid descending date; run;
...
data mna_media_with_ad11; set mna_media_with_ad11; rel_deal_size = tranvalue / mve_ad11; run; 
...
libname outlib "&out";
data outlib.mna_media_comp_crsp; set mna_media_with_ad11; run;
